                ...
                <div class="wsus__sign_form_area">
                    @if (session('status') == 'verification-link-sent')
                        <div class="alert alert-success" role="alert">
                            <p class="text-dark">A new verification link has been sent to the email address you provided
                    ...
                    <form method="POST" action="{{ route('verification.send') }}">
                        @csrf
                        <h2>Email Verification<span>!</span></h2>
                        <p class="new_user mt-3">
                        ...
                        <div class="col-xl-12">
                            <div class="wsus__login_form_input">
                                <button type="submit" class="common_btn">Resend Verification Email</button>
                            </div>
                        </div>
                    </form>

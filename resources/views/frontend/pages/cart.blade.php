    ...
    <section class="wsus__cart_view mt_120 xs_mt_100 pb_120 xs_pb_100">
        <div class="container">
                        ...
                        <div class="table-responsive">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="pro_img">
                                            <img src="{{ asset($item->course->thumbnail) }}" alt="product" class="img-fluid w-100">
                                        </td>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xxl-4 col-md-7 col-lg-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">

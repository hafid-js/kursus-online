          ...
          <div class="container-xl">
            <div class="row row-deck row-cards">
                      ...
                      <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                        <div class="divide-y">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/002m.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/003m.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/000f.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/001f.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/002f.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/003f.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/006m.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/004f.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/007m.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/009m.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/010m.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/005f.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('admin/assets/img/avatars/006f.jpg') }})"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                  ...
                  <div class="card-table table-responsive">
                    <table class="table table-vcenter">
                      ...
                      <tbody>
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url({{ asset('admin/assets/img/avatars/000m.jpg') }})"></span>
                          </td>
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url({{ asset('admin/assets/img/avatars/002m.jpg') }})"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url({{ asset('admin/assets/img/avatars/003m.jpg') }})"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url({{ asset('admin/assets/img/avatars/000f.jpg') }})"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
              ...
              <div class="col-md-6 col-lg-4">
                <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" style="background-image: url({{ asset('admin/assets/img/sponsor-banner-homepage.svg)" aria-label="Sponsor Tabler!">
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter">
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="avatar avatar-sm" style="background-image: url({{ asset('admin/assets/img/avatars/001f.jpg') }})"></span>
                        </td>
                      </tr>
                    </table>
                  </div>

...
-->
<html lang="en" data-bs-theme-primary="teal" data-bs-theme-base="slate" data-bs-theme-radius="1.5"
...
<head>
    ...
    <link href="{{ asset('admin/assets/css/tabler-themes.min.css?1752697826') }}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->

      ...
      <div class="container container-tight py-4">
        <div class="text-center mb-4">
          <a href="." class="navbar-brand navbar-brand-autodark">
            <img src="{{ asset('admin/assets/img/logo.svg') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
          </a>
        </div>
        <x-auth-session-status class="mb-4" :status="session('status')" />
          ...
          <div class="card-body">
            <h2 class="h2 text-center mb-4">Login to your account</h2>
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control password" id="email" name="email" value="{{ old('email') }}" placeholder="your@gmail.com" required autofocus autocomplete="username">
                <x-input-error :messages="$errors->get('email')" class="mt-2" />
              </div>
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat toggle-password">
                  <input type="password" name="password" class="form-control password"  placeholder="Your password"  autocomplete="off">

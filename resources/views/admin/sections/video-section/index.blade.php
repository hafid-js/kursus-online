                ...
                <div class="row row-cards">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.video-section.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <x-input-block name="video_url" value="{{ $video?->video_url }}" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <x-input-block name="button_text" value="{{ $video?->button_text }}" />
                                                <x-input-error :messages="$errors->get('button_text')" class="mt-2" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <x-input-block name="button_url" value="{{ $video?->button_url }}" />

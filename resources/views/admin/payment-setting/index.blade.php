                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="#client-server" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="paypal_mode" class="form-control">
                                                            ...
                                                            <option @selected(config('gateway_settings.paypal_mode') == 'live') value="live">Live
                                                            </option>
                                                        </select>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="paypal_currency" class="form-select select2 col-md-5">

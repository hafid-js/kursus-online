                                            ...
                                            <tbody>
                                                @forelse ($instructorRequests as $request)
                                                    <tr id="row-{{ $request->id }}">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.instructor-doc-download', $request->id) }}"
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                } elseif ($request->document_status === 'pending') {
                                                            ...
                                                            @endphp
                                                            <select
                                                                class="form-control update-approval-status {{ $validationClass }}"
                                                                data-id="{{ $request->id }}">
                                                                <option @selected($request->document_status == 'pending') value="pending">Pending
                                                                </option>
                                                                <option @selected($request->document_status == 'approved') value="approved">
                                                                    Approved</option>
                                                                <option @selected($request->document_status == 'rejected') value="rejected">
                                                                    Rejected</option>
                                                            </select>
                                                        </td>
                                                    </tr>

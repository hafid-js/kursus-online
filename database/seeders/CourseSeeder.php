...
class CourseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $instructorList = [1001, 1002, 1003, 1004, 1005, 1006, 1009, 1011, 1012];
    ...
    {
        $files = \File::files(public_path('/uploads/'));  // Get all files from the path
        ...
        return '/uploads/' . $fileInfo['filename'] . '.' . $fileInfo['extension']; // Build filename
    }
}
